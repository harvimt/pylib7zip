...
if 'win' in sys.platform:
	...
	free_propvariant = ole32.PropVariantClear
else:
...
def get_prop(idx, propid, get_fn, prop_name, convert, istype=None):
	#log.debug('get_prop(%d, %d, %s, -, istype=%r)',
		#idx, propid, get_fn.__name__, istype)
	...
	if as_pvar.vt in (VARTYPE.VT_EMPTY, VARTYPE.VT_NULL):
